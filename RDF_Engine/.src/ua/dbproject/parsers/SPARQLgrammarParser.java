...
public class SPARQLgrammarParser extends Parser {
	...
	public static class ProgContext extends ParserRuleContext {
		public List<TerminalNode> NEWLINE() { return getTokens(SPARQLgrammarParser.NEWLINE); }
		public TerminalNode NEWLINE(int i) {
			return getToken(SPARQLgrammarParser.NEWLINE, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SPARQLgrammarListener ) ((SPARQLgrammarListener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SPARQLgrammarListener ) ((SPARQLgrammarListener)listener).exitProg(this);
		}
	}
	...
	public static class ExprContext extends ParserRuleContext {
		public int _p;
		public TerminalNode INT() { return getToken(SPARQLgrammarParser.INT, 0); }
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SPARQLgrammarListener ) ((SPARQLgrammarListener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SPARQLgrammarListener ) ((SPARQLgrammarListener)listener).exitExpr(this);
		}
	}
